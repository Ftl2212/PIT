...
Além da instancia EC2 estamos utilizando um S3 para guardar os nossos assets utilizados no frontend, esses assets foram criados utilizando inteligência artificial também e não podem ser usadas comercialmente.# PIT II
